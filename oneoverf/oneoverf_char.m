function [beta, varmean] = oneoverf_char(nsamp, oversamp, alpha)
% ONEOVERF_CHAR - calculate various parameters for simulated 1/f^alpha
%                 noise
%  
...
%
%              So the normalization constant beta is calculated such that: 
%                   
...
%
% Syntax:  [beta, varmean] = oneoverf_char(1024, 8, 2.5);
%
% Inputs:
...
%
% Outputs:
%    beta    - the PSD normalization constant for variance=1
