...
YMatrix1 = (emp_mean(:,2:9)-calc_mean(:,2:9))./calc_mean(:,2:9);
...
% Create ylabel
ylabel({'(\sigma_\mu^2 - <|a_0|^2>)/<|a_0|^2>',''},'FontWeight','bold',...
   'FontSize',14,...
   'FontName',fontname);

% Create title
title('Accuracy of Variance of the Mean vs. \alpha & Oversampling','FontWeight','bold','FontSize',14,...
   'FontName',fontname);
...
set(legend1,'EdgeColor',[1 1 1],'Orientation','horizontal','YColor',[1 1 1],...
   'XColor',[1 1 1],...
   'Position',[0.199137937880702 0.141112975755995 0.650326797385621 0.0654017857142857]);

% Create textbox
annotation(figure1,'textbox',...
   [0.176283732660782 0.196126373626374 0.200765447667087 0.0384615384615385],...
   'String',{'Oversampling:'},...
   'FontWeight','demi',...
   'FontSize',14,...
   'FontName','Arial',...
